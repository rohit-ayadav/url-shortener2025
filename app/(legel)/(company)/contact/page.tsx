...
import { storeContactData } from '@/action/storeContactData';
...
const ContactPage = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await storeContactData(formData);
            if (!response.success) {
    ...
    const contactInfo = [
        {
            icon: Mail,
            title: 'Email',
            content: 'resourcesandupdates@gmail.com',
            link: 'mailto:resourcesandupdates@gmail.com'
        },
        {
            icon: Phone,
            title: 'Phone',
            content: '+91 (639) 217-7974',
            link: 'tel:+6392177974'
        },
        {
            icon: MapPin,
            title: 'Office',
            content: 'Chinhat Lucknow, Uttar Pradesh, India',
